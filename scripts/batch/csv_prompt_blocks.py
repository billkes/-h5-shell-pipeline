...
def csv_iap_block(
    ...
    header = (
        ...
        "- Implement EVERY productId from that file in Dart/IAP code — not only "
        "the first SKU.\n"
        "- Do NOT add ios/**/*.storekit or bind StoreKitConfiguration in "
        "Runner.xcscheme; IAP uses App Store Connect / sandbox via "
        "in_app_purchase only.\n"
